Colorado 2022 Select Race Data from the American Community Survey (2018-2022) at the County level
...
##Processing
ACS data for Colorado was retrieved with a Python script from the Census API.
The county data is available for all counties in Colorado. The script extracted the data for all counties in Colorado. 
