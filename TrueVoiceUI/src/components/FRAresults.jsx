...
const ElectoralResultsTable = ({ fips, characteristic }) => {
  ...
  const candidateInfo = {
    ...
    CO: [
      { district: 1, dem: "Diana DeGette", rep: "Shane Bolling" },
      { district: 2, dem: "Joe Neguse", rep: "Charles Winn" },
      { district: 3, dem: "Diane Mitsch Bush", rep: "Lauren Boebert" },
      { district: 4, dem: "Ike McCorkle", rep: "Ken Buck" },
      { district: 5, dem: "Doug Lamborn", rep: "Jillian Freeland" },
      { district: 6, dem: "Jason Crow", rep: "Steve House" },
      { district: 7, dem: "Ed Perlmutter", rep: "Casper Stockham" },
